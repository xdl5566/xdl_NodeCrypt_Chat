// Simple i18n utility for Private Chat Room
// 秘聊室 简单国际化工具
...
const LANGUAGES = {
	en: {
		...
		translations: {
			// Meta tags for SEO
			'meta.description': 'Private Chat Room - True end-to-end encrypted chat system, no database, all messages encrypted locally, server only relays encrypted data.',
			'meta.keywords': 'Private Chat Room - End-to-End encryption, security, chat, WebSocket, Cloudflare Workers, JavaScript, E2EE, anonymous communication, AES, ECDH, RSA, ChaCha20, security, open source, private chat room, shuaiplus',
			'meta.og_title': 'Private Chat Room - End-to-End Encrypted Chat System',
			'meta.og_description': 'Private Chat Room - A zero-knowledge, end-to-end encrypted open source chat system where all encryption and decryption is done locally on the client side, and servers cannot access plaintext. Supports multi-platform deployment, secure, anonymous, no message history.',
			'meta.twitter_title': 'Private Chat Room - End-to-End Encrypted Chat System',
			'meta.twitter_description': 'Private Chat Room is a zero-knowledge, end-to-end encrypted open source chat system where all encryption and decryption is done locally on the client side, and servers cannot access plaintext.',
			
			// Login and main UI
			'ui.enter_node': 'New Or Enter a Room',
			'ui.username': 'Username',
			'ui.node_name': 'Room number',
			...
			'help.what_is_nodecrypt': '🔐 What is Private Chat Room?',			
			'help.what_is_nodecrypt_desc': 'Private Chat Room is a true zero-knowledge end-to-end encrypted chat system. With a database-free architecture, all messages are encrypted locally on your device, and the server serves only as an encrypted data relay station, unable to access any of your plaintext content.',
			...
			'help.step_node_name': 'Set Room number',
			'help.step_node_name_desc': 'Unique identifier for the room',
			...
			'help.room_isolation_note': 'Same Room number but different passwords are two completely independent rooms that cannot communicate with each other.',
			'help.tip_private_chat': 'Private Chat',
			'help.tip_private_chat_desc': 'Use complex Room number and passwords, share only with specific people',
			'help.tip_group_chat': 'Group Chat',
			'help.tip_group_chat_desc': 'Use simple and memorable Room number and passwords for easy multi-user joining',
			'help.tip_security_reminder': 'Security Reminder',
			'help.tip_security_reminder_desc': 'Both Room number and password must be exactly the same to enter the same room',
	...
	zh: {
		...
		translations: {
			// Meta tags for SEO
			'meta.description': '秘聊室 - 真正的端到端加密聊天系统，无数据库，所有消息本地加密，服务器仅做加密数据中转。',
			'meta.keywords': '端到端加密, 安全, 聊天, WebSocket, Cloudflare Workers, JavaScript, E2EE, 匿名通信, AES, ECDH, RSA, ChaCha20, 安全, 开源, 秘聊室, shuaiplus',
			'meta.og_title': '秘聊室 - 端到端加密聊天系统',
			'meta.og_description': '秘聊室 是一个端到端加密的开源聊天系统，所有加密解密均在客户端本地完成，服务器无法获取明文。支持多平台部署，安全、匿名、无历史消息。',
			'meta.twitter_title': '秘聊室 - 端到端加密聊天系统',
			'meta.twitter_description': '秘聊室 是一个端到端加密的开源聊天系统，所有加密解密均在客户端本地完成，服务器无法获取明文。',
			
			// Login and main UI
			'ui.enter_node': '创建或进入聊天室',
			'ui.username': '用户名',
			'ui.node_name': '房间号',
			...
			'help.usage_guide': '使用帮助',
			'help.what_is_nodecrypt': '🔐 什么是 秘聊室',			
			'help.what_is_nodecrypt_desc': '秘聊室 是一个真正的端到端加密聊天系统。所有消息在您的设备上本地加密，服务器仅作为加密数据的中转站，无法获取您的任何明文内容。',
			'help.how_to_start': '🚀 快速开始',
			'help.step_username': '输入用户名',
			'help.step_username_desc': '选择一个在房间中显示的昵称，可以是任何您喜欢的名称',
			'help.step_node_name': '设置房间号',
			'help.step_node_name_desc': '房间的唯一标识符',
			'help.step_password': '设置房间密码',
			'help.step_password_desc': '用于区分不同房间，同时参与加密过程，提升安全性',
			'help.step_join': '点击"确定"',
			...
			'help.room_isolation_note': '相同房间号但不同密码的是两个完全独立的房间，无法相互通信。',
			'help.tip_private_chat': '私人对话',
			'help.tip_private_chat_desc': '使用复杂的房间号和密码，只分享给特定人员',
			'help.tip_group_chat': '群聊',
			'help.tip_group_chat_desc': '使用简单易记的房间号和密码，方便多人加入',
			'help.tip_security_reminder': '安全提醒',
			'help.tip_security_reminder_desc': '房间号和密码都需要完全一致才能进入同一个房间',
